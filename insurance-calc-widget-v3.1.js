...
.ic-btn-wrap{padding:16px 24px 8px;}\
...
<div class="ic-foot">v'+V+'</div>';
  ...
  // ── Сотрудник (blurred preview) ──
  var blurZone=document.createElement("div");blurZone.className="ic-blur-zone";

  var blurInner=document.createElement("div");blurInner.className="ic-blur-inner";
  blurInner.innerHTML='\
<div class="ic-sec">Сотрудник</div>\
<div class="ic-g2">\
  <div class="ic-f"><label>Зарплата за месяц, ₽</label><input type="text" value="'+DEF.sal+'" readonly></div>\
  <div class="ic-f"><label>Месяц расчёта</label><select><option>Январь</option></select></div>\
</div>\
<div class="ic-ct"><span>Вид договора:</span>\
  <button class="on">Трудовой</button>\
  <button class="off">ГПХ</button>\
</div>\
<button class="ic-extra-btn"><span style="font-size:10px">▼</span> Дополнительно</button>';
  blurZone.appendChild(blurInner);

  var blurFade=document.createElement("div");blurFade.className="ic-blur-fade";
  blurZone.appendChild(blurFade);

  var blurClick=document.createElement("div");blurClick.className="ic-blur-click";
  blurClick.onclick=function(){trackEvent("КЛИК",{type:"blurred_section_click"});};
  blurZone.appendChild(blurClick);
  body.appendChild(blurZone);

  // ── Button — leads to external link ──
  var bw=document.createElement("div");bw.className="ic-btn-wrap";
  var btnLink=document.createElement("a");
  btnLink.href="https://www.kontur-extern.ru/registration3";
  ...
  btnLink.textContent="Перейти к расчёту";
